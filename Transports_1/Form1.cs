namespace Transports_1
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            _vehicles.Add(new Truck("Truck1", 30, 60, FuelType.АИ92));
            _vehicles.Add(new Truck("Truck2", 30, 60, FuelType.АИ92));
            _vehicles.Add(new Truck("Truck3", 30, 60, FuelType.АИ92));
